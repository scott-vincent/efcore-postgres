using aws_dynamodb.Controllers;
...
namespace aws_dynamodb_tests.Controllers
{
    ...
    public class EmployeesControllerTests : TestsBase
    {
        ...
        */
        ...
        public void GetById_ReturnsEmployee()
        {
            ...
            // Setup service mocks
            _mockService.Setup(x => x.GetByIdAsync(It.IsAny<string>())).ReturnsAsync(employee);
            ...
            _mockService.Verify(x => x.GetByIdAsync(It.IsAny<string>()), Times.Once);
        ...
        {
            // Setup service mocks
            _mockService.Setup(x => x.GetByIdAsync(It.IsAny<string>()))
        ...
        public void Add_ReturnsCreatedEmployee()
        {
            ...
            Assert.NotEqual("", newEmployee.Id);
        }
